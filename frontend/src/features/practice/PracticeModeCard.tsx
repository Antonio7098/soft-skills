...
import { PracticeModePreviewModal } from './PracticeModePreviewModal';
  ...
  return (
    <>
      <Card interactive className="flex flex-col gap-4 p-6 text-center">
        ...
        <Button className="w-full mt-2" onClick={() => setShowPreview(true)} disabled={!targetId}>Start Practice</Button>
      </Card>
      <PracticeModePreviewModal
        isOpen={showPreview}
