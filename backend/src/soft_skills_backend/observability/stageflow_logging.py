...
from soft_skills_backend.observability.events import PipelineRunLog, ProviderCallLog
        ...
        **metrics: object,
        ...
        self._repository.upsert(
            ProviderCallLog(
                ...
                request_id=None if metrics.get("request_id") is None else str(metrics["request_id"]),
