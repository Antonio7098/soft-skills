"""Progression event recording helpers."""
...
class ProgressionEventRecorder:
    """Structured event recorder for progression workflows."""

    def __init__(self, workflow_events: SqlAlchemyWorkflowEventRepository) -> None:
        self._workflow_events = workflow_events
        self._logger = get_logger("soft_skills_backend.progression")
