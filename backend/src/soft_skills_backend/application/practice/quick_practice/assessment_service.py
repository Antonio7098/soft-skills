...
from soft_skills_backend.application.practice.models import ValidatedAssessmentPayload
from soft_skills_backend.domain.errors import AppError, scoring_error
