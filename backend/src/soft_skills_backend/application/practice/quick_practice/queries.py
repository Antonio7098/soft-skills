...
from .views import can_use_collection
...
def load_learner_context(
    ...
    from soft_skills_backend.persistence.models import LearnerProfileRecord
...
def load_resolved_attempt(
    ...
    from soft_skills_backend.persistence.models import PracticeSessionRecord
