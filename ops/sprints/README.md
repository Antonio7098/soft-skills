# SoftSkills Sprint Docs

These sprint documents turn the roadmap into execution slices. Each sprint must
be run with [CONSTITUTION.yml](/home/antonioborgerees/df/soft-skills/ops/CONSTITUTION.yml)
and the relevant `ops/mvp-spec/` files open during planning and implementation.

**Canonical MVP documentation lives in `ops/mvp-spec/`.** Sprint and process
documents in `ops/` should be updated alongside implementation when behavior,
contracts, or sequencing change.

## Sprint Order

1. [Sprint 0: Canon Lock And Delivery Rules](/home/antonioborgerees/df/soft-skills/ops/sprints/sprint-00-canon-lock.md)
2. [Sprint 1: Foundation And Composition Root](/home/antonioborgerees/df/soft-skills/ops/sprints/sprint-01-foundation-and-composition-root.md)
3. [Sprint 2: Identity And Content Foundations](/home/antonioborgerees/df/soft-skills/ops/sprints/sprint-02-identity-and-content-foundations.md)
4. [Sprint 3: Quick Practice Vertical Slice](/home/antonioborgerees/df/soft-skills/ops/sprints/sprint-03-quick-practice-vertical-slice.md)
5. [Sprint 4: Scenario And Interview Runtime](/home/antonioborgerees/df/soft-skills/ops/sprints/sprint-04-scenario-and-interview-runtime.md)
...
- Every sprint must include documentation updates.
- Every sprint must include unit, integration, and backend smoke coverage.
- Real-provider smokes are required for provider-backed flows in scope.
- Frontend work is intentionally decoupled and does not appear in these sprint docs.
